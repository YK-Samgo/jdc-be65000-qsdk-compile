...
define Device/jdcloud_be6500
	...
	# 与 QWRT 保持一致：sysupgrade 为 tar 包并附加 fwtool metadata
	IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
	# 与 QWRT 保持一致：factory 不附加 fwtool metadata
	IMAGE/factory.bin := append-kernel | pad-to $$$$(KERNEL_SIZE) | append-rootfs | pad-rootfs
endef
TARGET_DEVICES += $(if $(CONFIG_LINUX_5_4)$(CONFIG_LINUX_6_1)$(CONFIG_LINUX_6_6),jdcloud_be6500)
